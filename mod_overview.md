...
* Expanded standard recruitment options:
	o Sergeants-at-Arms (durable ranged support)
	o Chaplains (holy captains)
	o Vespertine Agents (holy assassins)
	o Battle Reliquaries (bless and protect nearby troops)
...
* New rituals:
	o Send Tsunami (water. Guess what it does)
	o Cloud Trapeze (Air. Teleport from a mountaintop in a spectacular fashion.)
...
o Summon Forest God (Primal gods only, no ents or beholders). More expensive to make up for consistency. 
o Summon Primal Being (Ents, Monster Boars, Beholders etc, and new additions like Smilodons and Faery Dragons. No depopulation of the plane.)
Minor Improvements:
